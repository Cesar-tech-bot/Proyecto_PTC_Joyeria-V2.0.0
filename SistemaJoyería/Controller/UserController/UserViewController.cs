...
namespace SistemaJoyería.Controller.UserController
{
    public class UserViewController
    {
        ...
        public UserViewController(FrmUserView view)
        {
            ...
            //view.btnAddClients.Click += new EventHandler(ShowAdd);
            ...
            //view.btnSearchUser.Click += new EventHandler(SearchClientsEvent);
            ////Sección de Validaciones
            //view.dgvUser.CellClick += new DataGridViewCellEventHandler(SelectClient);
